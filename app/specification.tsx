    ...
    <div className="docs-layout spec-layout">
      ...
      <main className="docs-content spec-content" id="spec-main" tabIndex={-1}>
        ...
        <section className="docs-section spec-section" id="conformance">
          ...
          <p>CLI:n kan även signera rapporter med en egen Ed25519-nyckel och verifiera dem mot en separat betrodd publik nyckel. Den nedladdningsbara rapporten är osignerad. JCS/SHA-256 verifierar JSON-bytes; kärnans semantiska labbidentiteter uppgraderas inte. Fulla produktionsprofiler, oberoende runtimes och en publicerad registertjänst återstår i Våg 5.</p>
