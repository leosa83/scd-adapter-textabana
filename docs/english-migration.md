...
| Surface | Completed through sprint 5.13 | Remaining work |
|---|---|---|
...
| Runtime and versioned conformance profiles | Kernel responsibilities are separated; diagnostic text, versioned profile prose and observable behavior are preserved. | English diagnostics/comments and profile prose in sprint 5.14, with compatibility tests and profile/manifest digest review. |
