...
test("the Interop 0.5 specification preserves its foundational contracts", () => {
  ...
  assert.match(source, /Nuvarande Playground implementerar uttryckligen avgränsade subsets/);
  ...
  assert.match(source, /Notebook och Annotation är contract-only och producerar ännu ingen domänoutput/);
